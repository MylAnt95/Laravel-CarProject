...
<div class="flex gap-10 mx-10 my-4">
    ...
    <div class="w-2/3">
        ...
        <div class="mt-4">
            ...
            <img src={{ asset('images/apple-car.webp') }} alt="Apple Logo" class="w-80 rounded-lg" />
        ...
        <div class="mt-4">
            ...
            <a href="https://www.motor1.com/news/710347/toyota-combustion-engine-filter-co2/" class="underline">Read
                ...
                clicking
                here</a>
            <img src={{ asset('images/toyota-carbon-filter.webp') }} alt="Apple Logo" class="w-80 rounded-lg" />
